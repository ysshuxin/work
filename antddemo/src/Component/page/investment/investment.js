...
class Investment extends Component {
  ...
  titlechange = value => {
    ...
    let tsxt = value.target.innerText;
    now.unshift(arrdom);
    this.setState({
      job: now.slice(0, num)
    });
        ...
        <div style={{ marginTop: "65px", overflow: "hidden" }}>
          ...
          >
            ...
            >
              <Button
                onClick={this.all}
                type={this.state.button ? "primary" : ""}
            ...
            >
              {this.state.nowarr.map((itme, index) => {
                return (
                  <li
                    className="li"
                    data-id={index}
          ...
          >
            {this.state.job.map((item, index) => {
              return (
                <div
                  style={{ width: "54%", margin: "0 auto", minWidth: "1258px" }}
                >
                  <h3
                    style={{
                      color: "rgba(0,0 ,0 ,0.45)",
                  ...
                  >
                    ...
                    <div style={{ display: "inline-block", width: "625px" }}>
                      ...
                      <p>
                        这里输入简介这里输入简介这里输入简介这里输入简介这里输入简介这里输入简介这里输入简介这里输入简介这里输入简介这里输入简介这里输入简介这里输入简介这里输入简介这里输入简介这里输入简介这里输入简介
                      </p>
                      <a target="_blank" href={"http://www.hcash.io"}>
                        www.hcash.io
                      </a>
                    </div>
                  </div>
            ...
            <p onClick={this.more} style={{ textAlign: "center" }}>
              {" "}
              加载更多
            </p>
          </div>
