<template>
  <div class="about_root">
    ...
    <div class="about_main">
      ...
      <p>团队核心成员来自阿里、京东、滴滴等一线互联网公司，</p>
      <p>产品与开发人员在金融、大数据、物联网、共享经济、电商、信息服务等多个领域均有丰富的产品设计和开发经验。</p>
      <p>我们严格遵守通用代码开发和产品设计规范，并基于阿里云等云服务平台构建提供全方位的监控和及时的日常运维。</p>
      <p>我们相信技术和产品的力量，我们像对待孩子一样对待每一个经手的产品，也非常希望用真诚和实力获得您的认可。</p>
      <p>预祝商祺！</p>
      <p>北京丽萨生活科技有限公司</p>
    </div>
    <div class="menmber">
